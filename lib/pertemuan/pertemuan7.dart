...
class RadiobuttonPage extends StatefulWidget {
  ...
  @override
  CompleteRadioButtonFormState createState() => CompleteRadioButtonFormState();
}

class CompleteRadioButtonFormState extends State<RadiobuttonPage>
                          ...
                          return Column(
                            children: [
                              Wrap(
                                spacing: 10,
                                runSpacing: 10,
                                children: jobOptions.asMap().entries.map((
                                  entry,
                                ) {
                                  int index = entry.key;
                                  var job = entry.value;
  ...
  Widget _buildGradientButton({
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF4287f5).withOpacity(0.3),
            blurRadius: 8,
            offset: const Offset(0, 4),
          ),
        ],
  ...
  Widget _buildOutlineButton({
    ...
    return OutlinedButton(
      ...
      style: OutlinedButton.styleFrom(
        side: const BorderSide(color: Color(0xFF4287f5), width: 2),
          ...
          actions: [
            TextButton(
              ...
              style: TextButton.styleFrom(
                backgroundColor: const Color(0xFF4287f5).withOpacity(0.1),
                foregroundColor: const Color(0xFF4287f5),
                shape: RoundedRectangleBorder(
  ...
  Widget _buildModernInfoRow(IconData icon, String label, String value) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF4287f5).withOpacity(0.05),
        borderRadius: BorderRadius.circular(14),
      ),
      child: Row(
        children: [
          Icon(icon, size: 18, color: const Color(0xFF4287f5)),
          const SizedBox(width: 12),
          Text(
            '$label:',
            style: const TextStyle(
