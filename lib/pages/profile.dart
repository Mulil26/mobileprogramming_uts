...
class _ProfilePageState extends State<ProfilePage> {
  ...
  String nim = '241011701032';
  String email = 'ulilabror6@gmail.com';
  String phone = '+62 8892 1080 38';
  String kelas = '04 SIFE 009';
  String occupation = 'Sistem Informasi';
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        _buildStatCard('Semester', '4', Icons.photo_library),
                        _buildStatCard('IPS', '3.99', Icons.grade_outlined),
                        _buildStatCard('IPK', '3.99', Icons.grade),
                      ],
                    ),
                    ...
                    _buildInfoRow(Icons.location_city, kelas),
                        ...
                        Expanded(
                          child: OutlinedButton(
                            ...
                            style: OutlinedButton.styleFrom(
                              foregroundColor: const Color(0xFF4287f5),
                              padding: const EdgeInsets.symmetric(vertical: 14),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(12),
                              ),
  ...
  Widget _buildStatCard(String label, String value, IconData icon) {
    return Expanded(
      child: Container(
        ...
        child: Column(
          children: [
            Icon(icon, color: const Color(0xFF4287f5), size: 28),
            const SizedBox(height: 8),
            Text(
              value,
              style: const TextStyle(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(icon, color: const Color(0xFF4287f5), size: 20),
          ),
        ...
        return SafeArea(
          child: Column(
            ...
            children: [
              ...
              ListTile(
                leading: const Icon(Icons.camera_alt, color: Color(0xFF4287f5)),
              ...
              ListTile(
                leading: const Icon(Icons.link, color: Color(0xFF4287f5)),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  _buildTextField(kelasController, 'Kelas', Icons.location_city),
                  const SizedBox(height: 16),
                  _buildTextField(
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            prefixIcon: Icon(icon, color: const Color(0xFF4287f5)),
            border: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12),
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12),
              borderSide: const BorderSide(color: Color(0xFF4287f5), width: 2),
            ),
            contentPadding: const EdgeInsets.symmetric(
              horizontal: 16,
              vertical: 12,
